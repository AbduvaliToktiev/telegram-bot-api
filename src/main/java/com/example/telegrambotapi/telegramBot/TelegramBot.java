package com.example.telegrambotapi.telegramBot;

import com.example.telegrambotapi.config.BotConfig;
import com.example.telegrambotapi.modals.dto.CurrencyDto;
import com.example.telegrambotapi.service.impl.CurrencyServiceImpl;
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (update.hasMessage() && update.getMessage().hasText()) {
            ...
            if ("/start".equals(messageText)) {
                ...
                try {
                    currency = currencyService.getCurrencyRates(currencyDto, messageText);
